...
Unity Editor上部のメニューバーに **Novella** メニューが表示されます。各項目はUI要素の自動生成・配線を行うビルダーや、開発支援ツールです。全29項目の詳細は [Documentation~/editor-menu-reference.md](Documentation~/editor-menu-reference.md) を参照してください。
